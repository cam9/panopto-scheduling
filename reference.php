...
<?
    ...
    $SMClient = new SessionManagementClient($server, $auth);
     ...
     try
     {
         ...
         $endDateAndTimeOfRecurrence->setDate(2013, 04, 24);
         $endDateAndTimeOfRecurrence->setTime(20, 55, 00);
         
         $guids = $RRMClient->scheduleNewRecurringRecording(
         	"Php scheduled recording", "4b7dd8b9-ae16-409b-bd98-aa29d66ebe3b", 
         	false, 
         	$startDateAndTime->format("Y-m-d\TH:i:s"), 
         	$endDateAndTime->format("Y-m-d\TH:i:s"), 
         	$repeatingDaysOfWeek, $endDateAndTimeOfRecurrence->format("Y-m-d\TH:i:s"), 
         	$recorderSettings
         );
         echo "<pre>";print_r($guids->getGuids());echo "</pre>";
     }
